  ...
  return (
    <section id="reviews" className="bg-cream/40 py-8 md:py-16">
      <div className="mx-auto max-w-7xl px-3 md:px-6">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-3 md:mb-10 md:gap-6">
        ...
        <div className="relative px-1 md:px-16">
          <button
            type="button"
            onClick={() => goToPage("prev")}
            className="absolute left-1 top-1/2 z-10 inline-flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-card/90 text-foreground shadow-card transition hover:bg-rose-soft md:left-0 md:h-11 md:w-11"
          ...
          {reviewPages[page].map((r) => (
            <article
              ...
              className="group flex min-h-[140px] flex-col rounded-2xl border border-border bg-card p-3 shadow-card transition-all hover:-translate-y-1 hover:shadow-elegant md:min-h-[170px] md:rounded-[1.5rem] md:p-4"
            >
              <div className="mb-2 flex items-center gap-2 md:mb-3 md:gap-3">
                <div className="relative flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-rose font-display text-sm text-primary md:h-11 md:w-11 md:text-base">
          ...
          <button
            ...
            className="absolute right-1 top-1/2 z-10 inline-flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-card/90 text-foreground shadow-card transition hover:bg-rose-soft md:right-0 md:h-11 md:w-11"
