...
export function Header() {
  return (
    <>
      ...
      <nav className="mx-auto flex max-w-7xl justify-between gap-1 overflow-x-auto whitespace-nowrap px-3 py-2 text-[11px] text-foreground/75 [scrollbar-width:none] md:px-6 lg:hidden [&::-webkit-scrollbar]:hidden">
        <a
          href="#services"
          className="flex-1 rounded-full border border-border bg-card/70 px-2.5 py-1.5 text-center transition-colors hover:text-primary"
        >
          Услуги
        </a>
        <a
