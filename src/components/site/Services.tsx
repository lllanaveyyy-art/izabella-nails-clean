            ...
            >
              ...
              <div className="mt-auto flex items-end justify-between gap-2.5 border-t border-border pt-2.5 md:pt-5">
                <div>
                  ...
                  <div className="whitespace-nowrap font-display text-base text-foreground md:text-2xl">
                    {s.price}
                  </div>
                </div>
                <a
                  ...
                  className="inline-flex shrink-0 items-center gap-1 whitespace-nowrap rounded-full border border-primary/15 bg-rose-soft/70 px-1 py-0.5 text-[9px] font-medium text-primary transition-all hover:bg-rose-soft md:gap-1.5 md:text-sm md:hover:gap-2.5"
                >
                  Записаться
