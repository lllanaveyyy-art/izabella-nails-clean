...
export function Hero() {
  const visual = (
    <div className="relative ml-auto w-full max-w-[13rem] overflow-visible md:mx-auto md:max-w-[22rem] lg:max-w-[25rem] xl:max-w-[27rem]">
      <div className="relative aspect-[4/5] rotate-2 overflow-hidden rounded-[1.75rem] shadow-elegant md:rotate-2 md:rounded-[2rem]">
        <img
          src={heroImg}
      ...
      <div className="absolute -right-1 -top-1 flex items-center gap-1 rounded-xl border border-white/70 bg-card/95 px-2 py-1 shadow-card backdrop-blur md:-right-6 md:-top-4 md:gap-2 md:rounded-2xl md:px-4 md:py-3">
    ...
    <section id="top" className="relative overflow-hidden bg-gradient-hero">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-[0.98fr_1.02fr] items-center gap-2 px-3 pb-8 pt-6 md:grid-cols-[1.08fr_0.92fr] md:gap-10 md:px-6 md:py-24 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
        <div className="flex flex-col items-start">
          <h1 className="font-display whitespace-nowrap text-[1.55rem] leading-[1.02] text-foreground md:text-7xl md:leading-[0.95] lg:text-8xl">
          ...
          <p className="mt-3 max-w-[9.25rem] text-[11px] leading-relaxed text-foreground/80 md:mt-7 md:max-w-xl md:text-xl md:leading-relaxed">
            Аккуратный маникюр,<br className="md:hidden" /> покрытие и дизайн.
            <br />
            Стерильно.<br className="md:hidden" /> Удобная онлайн-запись.
          </p>
          ...
          <div className="mt-4 flex flex-row flex-nowrap items-center gap-1.5 md:mt-8 md:flex-wrap md:gap-4">
            <a
              ...
              data-cta="booking"
              className="inline-flex min-h-9 w-[4.35rem] items-center justify-center rounded-full bg-primary px-1.5 py-1.5 text-center text-[8.5px] font-medium leading-tight md:min-h-0 md:w-auto text-primary-foreground shadow-elegant transition-opacity hover:opacity-90 md:px-8 md:py-4 md:text-sm"
            >
              Записаться<br className="md:hidden" /> онлайн
            </a>
            <a
              href="#services"
              className="inline-flex min-h-9 w-[4.35rem] items-center justify-center rounded-full border border-foreground/25 bg-card/35 px-1.5 py-1.5 text-center text-[8.5px] font-medium leading-tight md:min-h-0 md:w-auto text-foreground backdrop-blur transition-colors hover:bg-card md:px-8 md:py-4 md:text-sm"
            >
              Услуги<br className="md:hidden" /> и цены
            </a>
          </div>
